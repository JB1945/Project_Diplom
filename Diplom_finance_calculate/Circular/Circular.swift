...
//
//  Created by Sergei Otoka on 19.10.23.
//
...
open class Circular: UIView {
    ...
    public init(percentages:[Double],colors:[UIColor],aimationType:AnimationStyle = .animationFan, showPercentageStyle: PercentageStyle = .outward) {
    ...
    private func showPercentages(midAngel:Double, percentage:Double) {
        ...
        percentageLabel.text = percentage.formattedString
        percentageLabel.textColor = .myTextColor
